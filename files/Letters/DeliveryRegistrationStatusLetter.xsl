					...
					<xsl:when test="$registrationStatus = 'REGISTERED'">
						...
						<xsl:choose>
							<xsl:when test="$periodUnit != ''">
								...
								<tr><td> @@you_will_have@@ <xsl:value-of select="notification_data/delivery_registration/grace_period"></xsl:value-of> <xsl:value-of select="concat(' ', $periodUnit)" /> @@to_start_viewing@@</td></tr>
                                <xsl:choose>
                                    <xsl:when test="$includeGracePeriodInSessionPeriod = 'true'">
                                         <tr><td> @@you_will_have@@ <xsl:value-of select="notification_data/delivery_registration/session_period"></xsl:value-of> <xsl:value-of select="concat(' ', $sessionPeriodUnit)" /> @@to_view_resource@@</td></tr>
                                    </xsl:when>
                                    <xsl:otherwise>
                                         <tr><td> @@once_started_viewing@@ @@you_will_have@@ <xsl:value-of select="notification_data/delivery_registration/session_period"></xsl:value-of> <xsl:value-of select="concat(' ', $sessionPeriodUnit)" /> @@to_view_resource@@</td></tr>
                                    </xsl:otherwise>
                                </xsl:choose>
							</xsl:when>
							<xsl:otherwise>
