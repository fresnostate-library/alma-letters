...
<tr><td>&#160;</td></tr>
						<tr>
							<td>@@following_item_requested_on@@ <xsl:value-of select="notification_data/request/create_date"/>, will be available for pickup at the Circulation Desk shortly. Please allow up to one hour from the time of this notice for processing to be completed.</td>
						</tr>
<tr><td>&#160;</td></tr>
